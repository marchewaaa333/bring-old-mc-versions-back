...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 110, "Reconnect"));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	this.mc.displayGuiScreen(new GuiConnecting(this, this.mc, new ServerData(Minecraft.getMinecraft().getServerData().serverMOTD, Minecraft.getMinecraft().getServerData().serverIP)));
        }
    }
